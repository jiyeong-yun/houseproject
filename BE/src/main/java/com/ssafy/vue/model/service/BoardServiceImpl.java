...
//	}
	...
	public List<MemoDto> listMemo(int articleno) throws Exception {
		List<MemoDto> list=sqlSession.getMapper(BoardMapper.class).listMemo(articleno);
	...
	public boolean writeMemo(MemoDto memoDto) throws Exception {
		...
		return sqlSession.getMapper(BoardMapper.class).writeMemo(memoDto) == 1;	
	}
	
	@Override
    public boolean deleteMemo(int memono) throws Exception {
        return sqlSession.getMapper(BoardMapper.class).deleteOneMemo(memono) == 1;
    }
